...
PomaiDB is a local-first embedded vector database in C++20 designed for crash-safe, low-RAM environments. This guide covers setup, the build workflow, and multi-language quickstarts using the C API.
...
## JavaScript (Node.js FFI) quickstart
...
## TypeScript (Node.js FFI) quickstart
