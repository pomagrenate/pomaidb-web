            ...
            <>
              ...
              >
                {displayedProjects.map(({ project }) => {
                  ...
                  // Generate slug for the project detail page
                  const projectSlug = project.details 
                    ? project.details.split('/').pop() 
                  ...
                  return (
                    <button
                      ...
                      className="group bg-white border border-[#EAEAEA] rounded-2xl p-6 shadow-xs hover:shadow-xl hover:border-[#6D5DFB]/40 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between cursor-pointer text-left"
                    >
                      <div>
